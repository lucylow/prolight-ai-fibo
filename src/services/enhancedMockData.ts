...
export const mockGenerationResults = [
  ...
  {
    image_url: getPlaceholderImage(2048, 2048, 'product7'),
    image_id: 'gen_007',
    ...
    lightingAnalysis: {
      ...
      totalExposure: 1.85,
      contrastScore: 0.72,
      professionalRating: 8.2,
    },
    fibo_json: {
      main_light: { intensity: 0.75, color_temperature: 5500 },
      fill_light: { intensity: 0.4, color_temperature: 5500 },
    },
    generation_metadata: {
      preset: 'rembrandt_classic',
      scene_description: 'Luxury jewelry photography - diamond ring',
    },
  },
  {
    image_url: getPlaceholderImage(2048, 2048, 'product8'),
    image_id: 'gen_008',
    timestamp: new Date(Date.now() - 10 * 24 * 3600000).toISOString(), // 10 days ago
    lightingAnalysis: {
      keyFillRatio: 3.5,
      lightingStyle: 'dramatic',
      totalExposure: 2.05,
      contrastScore: 0.85,
      professionalRating: 9.1,
    },
    fibo_json: {
      main_light: { intensity: 1.1, color_temperature: 5600 },
      fill_light: { intensity: 0.3, color_temperature: 5600 },
    },
    generation_metadata: {
      preset: 'dramatic',
      scene_description: 'High-end fashion accessory - designer handbag',
    },
  },
  {
    image_url: getPlaceholderImage(2048, 2048, 'product9'),
    image_id: 'gen_009',
    ...
    lightingAnalysis: {
      ...
      totalExposure: 1.65,
      contrastScore: 0.68,
      professionalRating: 7.8,
    },
    fibo_json: {
      main_light: { intensity: 0.7, color_temperature: 5600 },
      fill_light: { intensity: 0.45, color_temperature: 5600 },
    },
    generation_metadata: {
      preset: 'butterfly_classic',
      scene_description: 'Beauty product photography - cosmetics',
    },
  },
  {
    image_url: getPlaceholderImage(2048, 2048, 'product10'),
    image_id: 'gen_010',
    timestamp: new Date(Date.now() - 14 * 24 * 3600000).toISOString(), // 14 days ago
    lightingAnalysis: {
      keyFillRatio: 2.6,
      lightingStyle: 'classical_portrait',
      totalExposure: 1.92,
      contrastScore: 0.76,
      professionalRating: 8.6,
    },
    fibo_json: {
      main_light: { intensity: 0.82, color_temperature: 5600 },
      fill_light: { intensity: 0.38, color_temperature: 5600 },
    },
    generation_metadata: {
      preset: 'loop_lighting',
      scene_description: 'Tech product photography - smartphone',
    },
  },
  {
    image_url: getPlaceholderImage(2048, 2048, 'product11'),
    image_id: 'gen_011',
    timestamp: new Date(Date.now() - 18 * 24 * 3600000).toISOString(), // 18 days ago
    lightingAnalysis: {
      keyFillRatio: 3.8,
      lightingStyle: 'high_contrast',
      totalExposure: 2.15,
    ...
    fibo_json: {
      main_light: { intensity: 1.05, color_temperature: 5600 },
      fill_light: { intensity: 0.28, color_temperature: 5600 },
    },
    generation_metadata: {
      preset: 'split_lighting',
      scene_description: 'Editorial fashion photography',
    },
  },
  {
    image_url: getPlaceholderImage(2048, 2048, 'product12'),
    image_id: 'gen_012',
    timestamp: new Date(Date.now() - 21 * 24 * 3600000).toISOString(), // 21 days ago
    lightingAnalysis: {
      keyFillRatio: 1.6,
      lightingStyle: 'soft_lighting',
      totalExposure: 1.55,
      contrastScore: 0.62,
      professionalRating: 7.2,
    },
    fibo_json: {
      main_light: { intensity: 0.65, color_temperature: 5600 },
      fill_light: { intensity: 0.48, color_temperature: 5600 },
    },
    generation_metadata: {
      preset: 'highkey',
      scene_description: 'Clean e-commerce product shot',
    },
  },
];
...
export const mockProjects: Project[] = [
  ...
  {
    id: 'proj_004',
    bria_id: 'bria_proj_004',
    name: 'Jewelry Premium',
    ip_type: 'stylized_scene',
    medium: 'photograph',
    description: 'Luxury jewelry photography with emphasis on sparkle',
    metadata: { category: 'jewelry', style: 'luxury' },
    created_at: new Date(Date.now() - 10 * 24 * 3600000).toISOString(),
    updated_at: new Date(Date.now() - 2 * 24 * 3600000).toISOString(),
  },
  {
    id: 'proj_005',
    bria_id: 'bria_proj_005',
    name: 'Tech Products',
    ip_type: 'stylized_scene',
    medium: 'photograph',
    description: 'Modern tech product photography with clean aesthetics',
    metadata: { category: 'electronics', style: 'modern' },
    created_at: new Date(Date.now() - 5 * 24 * 3600000).toISOString(),
    updated_at: new Date(Date.now() - 1 * 24 * 3600000).toISOString(),
  },
  {
    id: 'proj_006',
    bria_id: 'bria_proj_006',
    name: 'Fashion Accessories',
    ip_type: 'stylized_scene',
    medium: 'photograph',
    description: 'Premium fashion accessory photography',
    metadata: { category: 'fashion', style: 'premium' },
    created_at: new Date(Date.now() - 12 * 24 * 3600000).toISOString(),
    updated_at: new Date(Date.now() - 4 * 24 * 3600000).toISOString(),
  },
  {
    id: 'proj_007',
    bria_id: 'bria_proj_007',
    name: 'Portrait Studio',
    ip_type: 'stylized_scene',
    medium: 'photograph',
    description: 'Professional portrait lighting setups',
    metadata: { category: 'portrait', style: 'classical' },
...
export const mockDatasets: Dataset[] = [
  ...
  },
  {
    id: 'ds_005',
    bria_id: 'bria_ds_005',
    project_id: 'bria_proj_004',
    name: 'Jewelry Premium Set',
    description: 'Luxury jewelry photography collection',
  ...
  },
  {
    id: 'ds_006',
    bria_id: 'bria_ds_006',
    project_id: 'bria_proj_005',
    name: 'Tech Products v1',
  ...
  },
  {
    id: 'ds_007',
    bria_id: 'bria_ds_007',
    project_id: 'bria_proj_006',
    name: 'Fashion Accessories Set',
    description: 'Premium fashion accessory shots',
  ...
  },
  {
    id: 'ds_008',
    bria_id: 'bria_ds_008',
    project_id: 'bria_proj_007',
    name: 'Portrait Studio Collection',
    description: 'Professional portrait lighting setups',
    created_at: new Date(Date.now() - 7 * 24 * 3600000).toISOString(),
    updated_at: new Date(Date.now() - 1 * 24 * 3600000).toISOString(),
  },
...
export const mockModels: Model[] = [
  ...
  {
    id: 'model_005',
    bria_id: 'bria_model_005',
    dataset_id: 'bria_ds_005',
    name: 'Jewelry Premium Model',
    training_mode: 'expert',
    training_version: 'max',
    created_at: new Date(Date.now() - 8 * 24 * 3600000).toISOString(),
    updated_at: new Date(Date.now() - 3 * 24 * 3600000).toISOString(),
  ...
  {
    id: 'model_006',
    bria_id: 'bria_model_006',
    dataset_id: 'bria_ds_006',
    name: 'Tech Products Model',
    training_mode: 'fully_automated',
    training_version: 'light',
  ...
  {
    id: 'model_007',
    bria_id: 'bria_model_007',
    dataset_id: 'bria_ds_007',
    name: 'Fashion Accessories Model',
    training_mode: 'expert',
    training_version: 'max',
    created_at: new Date(Date.now() - 10 * 24 * 3600000).toISOString(),
    updated_at: new Date(Date.now() - 4 * 24 * 3600000).toISOString(),
  ...
  {
    id: 'model_008',
    bria_id: 'bria_model_008',
    dataset_id: 'bria_ds_008',
    name: 'Portrait Studio Model',
    training_mode: 'fully_automated',
    training_version: 'light',
    created_at: new Date(Date.now() - 6 * 24 * 3600000).toISOString(),
    updated_at: new Date(Date.now() - 1 * 24 * 3600000).toISOString(),
...
export const mockJobs: TailoredJob[] = [
  ...
  },
  {
    id: 'job_005',
    type: 'generate',
    model_id: 'bria_model_005',
    request_id: 'req_gen_003',
    status_url: 'https://api.bria.ai/v2/tailored/status/req_gen_003',
    status: 'succeeded',
    status_payload: { progress: 100 },
    result: { url: getPlaceholderImage(1024, 1024, 'generated3') },
    prompt: 'Diamond ring on velvet surface with soft beauty lighting',
  ...
  },
  {
    id: 'job_006',
    type: 'generate',
    model_id: 'bria_model_006',
    request_id: 'req_gen_004',
    status_url: 'https://api.bria.ai/v2/tailored/status/req_gen_004',
    status: 'succeeded',
    status_payload: { progress: 100 },
    result: { url: getPlaceholderImage(1024, 1024, 'generated4') },
    prompt: 'Modern smartphone on reflective surface with clean studio lighting',
  ...
  },
  {
    id: 'job_007',
    type: 'generate',
    model_id: 'bria_model_007',
    request_id: 'req_gen_005',
    status_url: 'https://api.bria.ai/v2/tailored/status/req_gen_005',
    status: 'succeeded',
    status_payload: { progress: 100 },
    result: { url: getPlaceholderImage(1024, 1024, 'generated5') },
    prompt: 'Designer handbag on marble surface with elegant lighting',
  ...
  },
  {
    id: 'job_008',
    type: 'training',
    model_id: 'bria_model_008',
    request_id: 'req_training_002',
    status_url: 'https://api.bria.ai/v2/tailored/status/req_training_002',
    status: 'training',
    status_payload: { progress: 32 },
    prompt: undefined,
    created_at: new Date(Date.now() - 1 * 24 * 3600000).toISOString(),
  ...
  },
  {
    ...
    type: 'generate',
    model_id: 'bria_model_004',
    request_id: 'req_gen_006',
    status_url: 'https://api.bria.ai/v2/tailored/status/req_gen_006',
    status: 'succeeded',
    status_payload: { progress: 100 },
    result: { url: getPlaceholderImage(1024, 1024, 'generated6') },
    prompt: 'Premium cosmetics product on white background with soft lighting',
  ...
  },
  {
    ...
    type: 'reimagine',
    model_id: 'bria_model_001',
    request_id: 'req_reimagine_002',
    status_url: 'https://api.bria.ai/v2/tailored/status/req_reimagine_002',
    status: 'processing',
    status_payload: { progress: 78 },
    prompt: 'Reimagine with higher contrast and cooler color temperature',
...
export const mockDashboardStats = {
  ...
  recentActivity: [
    ...
    {
      type: 'training',
      description: 'Started training Portrait Studio Model',
      timestamp: new Date(Date.now() - 1 * 24 * 3600000).toISOString(),
    },
    {
      type: 'generation',
      description: 'Generated image with Tech Products Model',
      timestamp: new Date(Date.now() - 4 * 3600000).toISOString(),
    },
    {
      type: 'project',
      description: 'Created new project: Portrait Studio',
    ...
    {
      type: 'generation',
      description: 'Generated image with Jewelry Premium Model',
